...
INSERT INTO `csm_business_service` VALUES (100,'Selective editing','Selective editing is a general approach for the detection of influential errors. It is based on the idea of looking for influential errors with respect to the main results in order to focus the most accurate treatment on the corresponding subset of units to limit the costs of interactive editing, while maintaining the desired level of quality of estimates [GSDEM 2.0]'),(150,'Selemix','Detection of outliers and influential errors using a latent variable model'),(200,'Relais','Record Linkage at Istat'),(201,'FS4, R2BEAT, SAS macro Cube, R-BalancedSampling','FS4, R2BEAT, SAS macro Cube, R-BalancedSampling'),(202,'Mauss-R, R2Beat, Multiway, Sampling Strata','Mauss-R, R2Beat, Multiway, Sampling Strata'),(203,'Re-Genesees','Re-Genesees'),(204,'AGAIN (solo per specifiche indagini)','AGAIN (solo per specifiche indagini)'),(205,'AGAIN (solo per specifiche indagini); applicazione sviluppata per il Censimento della popolazione nel 2018 (Cuccia, Bianchi)','AGAIN (solo per specifiche indagini); applicazione sviluppata per il Censimento della popolazione nel 2018 (Cuccia, Bianchi)'),(206,'Concord-SCIA','Concord-SCIA'),(207,'Regenesses','Regenesses'),(208,'Procedure ad hoc SAS o R','Procedure ad hoc SAS o R'),(209,'Procedure ad hoc SAS o R , relais','Procedure ad hoc SAS o R , relais'),(210,'Procedure ad hoc SAS o R\nLibreria SamplingStrata,  ecc','Procedure ad hoc SAS o R\nLibreria SamplingStrata,  ecc'),(211,'Mauss-R, R2Beat, Multiway, Sampling Strata','Mauss-R, R2Beat, Multiway, Sampling Strata'),(212,'Procedure ad hoc SAS (Proc survey select)  o R','Procedure ad hoc SAS (Proc survey select)  o R'),(213,'Procedure ad hoc SAS (Proc survey select) o R','Procedure ad hoc SAS (Proc survey select) o R'),(214,'Sas, R, SQL','Sas, R, SQL'),(215,'Sas (Banff), R (SeleMix)','Sas (Banff), R (SeleMix)'),(216,'Sas (Banff), R, SQL','Sas (Banff), R, SQL'),(217,'procedure ad hoc','procedure ad hoc'),(218,'ad esempio utilizzando libreria R \"MASS\"\"\"\"\"\"\"\"\"\"\"\"\"\"\"','ad esempio utilizzando libreria R \"MASS\"\"\"\"\"\"\"\"\"\"\"\"\"\"\"'),(219,'Pacchetto R mind','Pacchetto R mind'),(220,'Funzione diagnostic.R','Funzione diagnostic.R'),(221,'RLfunc','RLfunc'),(222,'fastLink; Rlfunc','fastLink; Rlfunc'),(223,'fastLink','fastLink'),(999,'Dummy','Placeholder for undefined processes and objects'),(1000,'fgffds','ffsdf'),(1001,'fdffdfdsf','f'),(1002,'ddd','dd'),(1003,'fdgfdgfd','fdgfgsgf'),(1004,'dfds','sfddss'),(1005,' Lettura dei dati grezzi dell\'indagine di riferimento',' Lettura dei dati grezzi dell\'indagine di riferimento'),(1006,'Lettura dati indagine',''),(1007,'Validatetools','Rule sets with validation rules may contain redundancies or contradictions.\nFunctions for finding redundancies and problematic rules are provided,\ngiven a set a rules formulated with \'validate\''),(1008,'Validatetools','Rule sets with validation rules may contain redundancies or contradictions.\nFunctions for finding redundancies and problematic rules are provided,\ngiven a set a rules formulated with \'validate\''),(1009,'SamplinStrata','Questo pacchetto è uno strumento utile alla determinazione della migliore stratificazione di un frame di campionamento, quello che garantisce il costo minimo del campione a condizione di soddisfare i vincoli di precisione in un caso multivariato e multidominio. Questo approccio si basa sull\'uso dell\'algoritmo genetico:'),(1010,'prova 11/10/2022','descr 11/10/2022'),(1011,'strum mercol 12/10/22','descr strum mercol 12/10/22'),(1012,'st ser 21 12 2022','descr st ser 21 12 2022'),(1013,'pippo','ppppppppppppppppppppppppppp'),(1014,'nuovo da eliminare',''),(1015,'nuovo 1230',''),(1016,'nuovo 1233',''),(1017,'ss',''),(1018,'pp',''),(1019,'dal',''),(1020,'pro',''),(1021,'ooooo',''),(1022,'propro',''),(1023,'desk app lib papiz',''),(1024,'yyyyyyyyyyyyyyyyyy',''),(1025,'proxxxxxxxxxxxxxxxxxx',''),(1026,'pippo_pippo',''),(1027,'rrrrrrrrrrrrrrrrrr',''),(1028,'dal-26',''),(1029,'fra','sds'),(1030,'wds','sds'),(1031,'xx','dsdfsd'),(1032,'ddddd',''),(1033,'ssssss',''),(1034,'da',''),(1035,'pppppprrrr',''),(1036,'ss','xx'),(1037,'dal',''),(1038,'xxxxx',''),(1039,'vvvvv',''),(1040,'tttt',''),(1041,'tttttt',''),(1042,'ttt',''),(1043,'yyyyy',''),(1044,'uuuuu',''),(1045,'iiiiii',''),(1046,'pro',''),(1047,'66666',''),(1048,'777777',''),(1049,'88888',''),(1050,'1111',''),(1051,'66666666666',''),(1052,'77777777777777',''),(1053,'dal',''),(1054,'proc',''),(1055,'proc',''),(1056,'ttttt',''),(1057,'ttttt',''),(1058,'tttttttt',''),(1059,'dal',''),(1060,'dal',''),(1061,'yyyyy',''),(1062,'ggggggggg',''),(1063,'pppppppppppp',''),(1064,'dal',''),(1065,'rrrrrrrrrrr',''),(1066,'dal',''),(1067,'proc',''),(1068,'dal',''),(1069,'yyyyyyyyyy',''),(1070,'yyy',''),(1071,'uuuuuuu',''),(1072,'yyyyyyyyyyyyyyyy',''),(1073,'yyyyyyyyyyyyyyyy',''),(1074,'999999999999999',''),(1075,'666666666666666',''),(1076,'tttttttttttttttttt',''),(1077,'pr',''),(1078,'dal',''),(1079,'ttttttttttttt',''),(1080,'yyyyyyyyyyyy',''),(1081,'yyyyyyyyyyyyyyyyyyyyy',''),(1082,'oooooooooooooooo',''),(1083,'yyyyyyyyyyyyyyy',''),(1084,'tttttttttttt',''),(1085,'ggggggggggggggg',''),(1086,'gggggggggggggggggg',''),(1087,'tttttttttttttt',''),(1088,'dal',''),(1089,'proc',''),(1090,'proce',''),(1091,'dal',''),(1092,'proc',''),(1093,'proc',''),(1094,'proce',''),(1095,'Prova','');
...
CREATE TABLE `csm_methodological_tool` (
  `ID` int NOT NULL AUTO_INCREMENT,
  `Release_Date` text COLLATE utf8mb4_unicode_ci,
...
-- Dump completed on 2022-12-13 11:48:06
